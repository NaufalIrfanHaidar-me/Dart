...
void main(List<String> args){
  var setJurusan = {'RPL', 'OTKP', 'TKJ', 'DG', 'TL', 'TB', 'TBSM', 'TPM', 'BDP', 'AKL'};
  var setRPL = {'X RPL 1', 'X RPL 2', 'XI RPL 1', 'XI RPL 2', 'XII RPL 1', 'XII RPL 2'};
  var setTKJ = {'X TKJ 1', 'X TKJ 2', 'XI TKJ 1', 'XI TKJ 2', 'XII TKJ 1', 'XII TKJ 2'};
  var setOTKP = {'X OTKP 1', 'X OTKP 2', 'X OTKP 3', 'XI OTKP 1', 'XI OTKP 2', 'XI OTKP 3', 'XI OTKP 4', 'XII OTKP 1', 'XII OTKP 2', 'XII OTKP 3', 'XII OTKP 4', 'XII OTKP 5'};
  var setDG = {'X DG 1', 'X DG 2', 'XI DG 1', 'XI DG 2', 'XII DG 1'};
  var setBDP = {'X BDP 1', 'X BDP 2', 'X BDP 3',  'X BDP 4', 'XI BDP 1', 'XI BDP 2', 'XI BDP 3', 'XI BDP 4', 'XI BDP 5', 'XII BDP 1', 'XII BDP 2', 'XII BDP 3', 'XII BDP 4'};
  var setTL = {'X TL 1', 'XI TL 1'};
  var setTB = {'X TB 1', 'XI TB 1'};
  var setTBSM = {'X TBSM 1', 'X TBSM 2', 'X TBSM 3', 'XI TBSM 1', 'XI TBSM 2', 'XII TBSM 1', 'XII TBSM 2'};
  var setTPM = {'X TPM 1', 'X TPM 2', 'X TPM 3', 'XI TPM 1', 'XI TPM 2', 'XII TPM 1', 'XII TPM 2'};
  var setAKL = {'X AKL 1', 'X AKL 2', 'X AKL 3', 'XI AKL 1', 'XI AKL 2',  'XI AKL 3', 'XII AKL 1', 'XII AKL 2', 'XII AKL 3', 'XII AKL 4'};
